      ...
      <div className={`container ${styles.dashboard__container}`}>
        ...
        <div className={styles.dashboard__about}>
          ...
          <p className={`${styles.dashboard__about__text} ${darkModeClass}`}>
            ООО &quot;ТЛТТРАНС&quot; — эксперт в пригоне автомобилей из Европы, США и Кореи.
            Мы подбираем, проверяем, доставляем и оформляем авто, снижая таможенные расходы для клиентов.
          </p>
        </div>
      </div>
    </section>
