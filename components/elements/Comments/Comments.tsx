...
const initialComments: Comment[] = [
  ...
  {
    name: 'Виктор',
    body: 'При доставке автомобиля поцарапали бампер, ремонт за счет компании.',
  ...
  {
    name: 'Alex',
    body: 'При оформлении заказа возникли проблемы, поцарапали бампер, ремонт за счет компании.',
  ...
  {
    name: 'Михаил',
    body: 'При транспортировке автомобиля случилось: поцарапали бампер, ремонт за счёт компании.',
  ...
  {
    name: 'Олег',
    body: 'По доставке авто произошла неприятность: поцарапали бампер, ремонт за счет компании.',
  ...
  {
    name: 'Anna Maria',
    body: 'Неудачный опыт: автомобиль доставили с царапинами на бампере, ремонт за счёт компании.',
  ...
  {
    name: 'John',
    body: 'При доставке автомобиля возникли проблемы: поцарапали бампер, ремонт за счёт компании.',
  ...
  {
    name: 'Марина',
    body: 'Автомобиль доставлен с повреждением: поцарапали бампер, ремонт за счёт компании.',
  ...
  {
    name: 'Наталья',
    body: 'При доставке возникли проблемы: поцарапали бампер, ремонт за счёт компании.',
  ...
  {
    name: 'Сергей',
    body: 'При доставке авто произошел инцидент: поцарапали бампер, ремонт за счёт компании.',
  ...
  {
    name: 'Виктор',
    body: 'При транспортировке авто поцарапали бампер, ремонт за счёт компании.',
  ...
  {
    name: 'Денис',
    body: 'При оформлении заказа обнаружены повреждения: поцарапали бампер, ремонт за счёт компании.',
  ...
  {
    name: 'Сергей',
    body: 'При транспортировке авто были повреждения: поцарапали бампер, ремонт за счет компании.',
    time: new Date('2019-05-15T18:30:15').getTime(),
  },
  {
    name: 'Michael',
    body: 'По доставке авто произошли неприятности: бампер повреждён, ремонт за счёт компании.',
  ...
  {
    name: 'Олег Иванов',
    body: 'Сервис разочаровал: автомобиль доставили с повреждением бампера, ремонт за счёт компании.',
