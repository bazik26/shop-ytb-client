...
const InStockFilter = () => {
  ...
  const loadFilteredParts = async (filterInStock: boolean) => {
    try {
      ...
      if (router.query.boiler) queryParams.append('boiler', String(router.query.boiler))
      if (router.query.parts) queryParams.append('parts', String(router.query.parts))
      ...
      const offset = Array.isArray(router.query.offset) ? router.query.offset[0] : router.query.offset || '0'
